...
impl Tok {
    ...
    pub const INDEX8: Self = Self(0x9E);
    pub const INDEX16: Self = Self(0x9F);
    pub const ACCUM8: Self = Self(0xA0);
    pub const ACCUM16: Self = Self(0xA1);
    pub const EMULATION: Self = Self(0xA2);
    pub const NATIVE: Self = Self(0xA3);
